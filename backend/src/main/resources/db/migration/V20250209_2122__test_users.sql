...
VALUES ('f6d0ba41-3f63-44ee-9f0d-7c04ea8d8619', 'Administrator', 'Testowy', true,
        '123456789', '2025-01-16', (select id from pracainz.user_credential where username = 'admin-test@gmail.com') )
    ON CONFLICT (id) DO NOTHING;
...
INSERT INTO pracainz.user_credential_role (user_id, role_id)
VALUES ((select id from pracainz.user_credential where username = 'admin-test@gmail.com'), (select id from pracainz.roles where name = 'ROLE_ADMIN'))
    ON CONFLICT (user_id,role_id) DO NOTHING;
INSERT INTO pracainz.user_credential_role (user_id, role_id)
VALUES ((select id from pracainz.user_credential where username = 'admin-test@gmail.com'), (select id from pracainz.roles where name = 'ROLE_USER'))
    ON CONFLICT (user_id,role_id) DO NOTHING;
COMMIT;
